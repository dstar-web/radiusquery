...
num_points = 20
dimension = 1024
filename = '/Users/dhruvrao/Desktop/rl/query_point1.txt'
normalized_points_file = '/Users/dhruvrao/Desktop/rl/normalized_query_point1.txt'

generate_random_points_to_file(num_points, dimension, filename)
print(f"{num_points} random points having dimension of {dimension} have been written to {filename}.")
